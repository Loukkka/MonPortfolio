...
import { User, Heart, Target, Lightbulb, Zap } from 'lucide-react';
          ...
          >
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                Je suis <span className="text-cyan-400 font-medium">Louka Poulbriere</span>, passionné par le <span className="text-cyan-400 font-medium">design graphique</span>, le <span className="text-cyan-400 font-medium">motion design</span> et le <span className="text-cyan-400 font-medium">développement web</span>.
              </p>
